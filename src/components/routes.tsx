    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Switch>
        ...
        <Route
          exact
          path="/certificates"
          component={login ? Certificates : Login}
        />
        <Route
          exact
          path="/certificates/:id"
          component={login ? CertificateItem : Login}
        />
        <Route exact path="/companies" component={login ? Companies : Login} />
        <Route
          exact
          path="/companies/:id"
          component={login ? CompanyItem : Login}
        />
        <Route exact path="/contacts" component={login ? Contacts : Login} />
        <Route
          exact
          path="/contacts/:id"
          component={login ? ContactItem : Login}
        />
        <Route
          exact
          path="/departments"
          component={login ? Departments : Login}
        />
        <Route
          exact
          path="/departments/:id"
          component={login ? DepartmentItem : Login}
        />
        <Route
          exact
          path="/educations"
          component={login ? Educations : Login}
        />
        <Route
          exact
          path="/educations/:id"
          component={login ? EducationItem : Login}
        />
        ...
        <Route
          exact
          path="/practices/:id"
          component={login ? PracticeItem : Login}
        />
        ...
        <Route
          exact
          path="/sirentypes"
          component={login ? SirenTypes : Login}
        />
        <Route
          exact
          path="/sirentypes/:id"
          component={login ? SirenTypeItem : Login}
        />
      </Switch>
    </Suspense>
  );
